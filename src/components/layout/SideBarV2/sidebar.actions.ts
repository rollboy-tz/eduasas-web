 ...
 *
 * File hili linaficha implementation ya dispatch actions
 * kutoka kwa components.
 *
 * Faida:
 * - Components hazijui action types.
 * - Refactoring inakuwa rahisi.
 * - API ya Sidebar inakuwa readable.
 *
 * @version 2.0.0
 */
 ...
 *
 * Hutumika kwa behavior kama:
 * minimal sidebar + hover = expand temporarily.
 *
 * @param dispatch Sidebar reducer dispatch function
 ...
 *
 * @param dispatch Sidebar reducer dispatch function
 * @param collapsed Ikiwa user amecollapse
 */
