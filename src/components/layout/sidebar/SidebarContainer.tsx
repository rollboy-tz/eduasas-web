...
/**
 * Props zinazohitajika na component ya `SidebarContainer`.
 */
...
/**
 * Component kuu ya Sidebar (Container) inayoshughulikia muundo wa kompyuta (Desktop) na simu (Mobile).
 * 
 * Inajumuisha:
 * - Mobile Overlay: Inayoonekana kwenye simu tu wakati menyu iko wazi.
 * - Header: Inayoonyesha EduAsasLogo na batani ya kufunga kwenye simu.
 * - Nav Area: Inayotumia `SidebarComposer` kuonyesha vyema orodha ya menyu.
 * - Footer: Batani ya kunja na kupanua sidebar (Collapse/Expand) kwenye Desktop.
 */
